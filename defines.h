...
#define FLOWSENSOR_POLLING_RATE   500   // flow sensor polling rate (ms), prev. defaulted to 1 ms
                                    // adjusting to allow debounce of slower mechanical (e.g. reed) switches
